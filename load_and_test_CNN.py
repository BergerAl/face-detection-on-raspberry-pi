...
#Test image
time_ = time.clock()
test_img = load_img('data/validation/Emma_Watson/640_leo_dicaprio_emma_watson.jpg', target_size=(200,200))
test_img.show()
image_as_array = img_to_array(test_img)
image_as_array = image_as_array.reshape((1,) + image_as_array.shape)
prediction = model.predict_proba(image_as_array, verbose=1)              # for vector output
