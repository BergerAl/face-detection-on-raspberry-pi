...
import time
#load model
json_file = open('models/full_model_face_40_epochs.json', 'r')
loaded_model_json = json_file.read()
json_file.close()
model = model_from_json(loaded_model_json)

#load weights
model.load_weights("models/full_model_face_40_epochs.h5")


#Test image
time_ = time.clock()
test_img = load_img('some_pics/.jpg', target_size=(150,150))
